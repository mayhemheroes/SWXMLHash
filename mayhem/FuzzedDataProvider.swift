...
class FuzzedDataProvider {
    ...
    func ConsumeEnum<T: RawRepresentable>(from: T.Type) -> T? where T.RawValue: FixedWidthInteger {
        let raw = ConsumeIntegralInRange(from: T.RawValue.min, to: T.RawValue.max)
